...
packagename="hostnamechanger"
############################################################
wget O /tmp/${packagename}.deb https://github.com/bayramkarahan/hostnamechanger/raw/refs/heads/master/hostnamechanger_1.0.0_amd64.deb
cd /tmp
