...
packagename="betikyukleyici"
############################################################
wget O /tmp/${packagename}.deb https://github.com/bayramkarahan/betikyukleyici/raw/refs/heads/master/betikyukleyici_2.1.0_amd64.deb
cd /tmp
