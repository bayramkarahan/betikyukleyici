...
/*
  ...
  on_orientation_changed(neworientation) {
    ...
    // Panel yüksekliğinin %50'si
    let size = Math.round(this._panelHeight * 0.5);
    ...
    if (this.orientation == St.Side.TOP || this.orientation == St.Side.BOTTOM) {
        ...
        // genişlik = %50 panel yüksekliği
        // yükseklik = panel yüksekliği
        this._line.set_size(size, this._panelHeight);
    ...
    // DİKEY PANEL (sol / sağ)
        ...
        // yükseklik = %50 panel yüksekliği
        // genişlik = panel yüksekliği
        this._line.set_size(this._panelHeight, size);
